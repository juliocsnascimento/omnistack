...
export default function Detail(){
    ...
    const message  = `Olá ${incident.name}, estou entrando em contato pois gostaria de ajudar no caso "${incident.title}" como o valor de R$ ${value}`
        ...
        <View style={style.container}>
            ...
            <View style={style.contactBox}>
                ...
                <View style={style.actions}>
                    ...
                    <TouchableOpacity style={style.action} onPress={senEmail}>
